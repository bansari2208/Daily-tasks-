    ...
    def test_generate_report_skips_invalid_json(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with open(test_log_file, "w", encoding="utf-8") as f:
                f.write('{"model_name": "llama-3.3-70b", "prompt_tokens": 10, "estimated_cost": 0.001, "provider": "MockPrimary", "success": true}\n')
                f.write('THIS IS INVALID JSON LINE\n')
                f.write('{"model_name": "llama-3.3-70b", "prompt_tokens": 20, "estimated_cost": 0.002, "provider": "MockPrimary", "success": true}\n')

            captured_output = StringIO()
            with patch("sys.stdout", captured_output):
                generate_report(log_file=test_log_file)
