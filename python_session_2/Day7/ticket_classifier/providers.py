...
import asyncio
import httpx
from .errors import TransportError, ModelOutputError
...
class MockPrimaryProvider:
    ...
    async def classify(self, ticket_text: str, force_outcome: str = None) -> dict:
        ...
        force_outcome can be used in unit tests: 'success', '429', '500', '400', 'timeout', 'invalid_output'.
        """
        ...
        if outcome == "429":
            ...
            raise ModelOutputError("Model output format is invalid.")
