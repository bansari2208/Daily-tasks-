...
def run_cost_experiment():
    """Calculates and displays financial model comparisons across models and prompts."""
    ...
    for model_name, rates in MODEL_PRICING.items():
        for prompt_name, tokens in PROMPTS.items():
            ...
            print(f"{model_name:<22} | {prompt_name:<20} | ${cost_per_req:<11.6f} | ${daily_cost:<9.2f} | ${monthly_cost:<11.2f} | {savings_pct:<9.1f}%")

    print("=" * 96)

    # Sort results by monthly cost to find cheapest configuration
    ...
    # Language Token Inflation section
...
def run_language_inflation_analysis():
    ...
    sample_texts = {
        ...
        "Hindi": "चेકआउट पेज पर भुगतान विफल रहा। कार्ड त्रुटि 402।"
    }
